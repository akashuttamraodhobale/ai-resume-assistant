...
4. Research Assistant (UGC Sponsored Project) (Oct 2013 - June 2014)
   - Prepared technical summaries and co-authored peer-reviewed scientific publications.
...
# On Streamlit Cloud, you set GEMINI_API_KEY as a secret
    ...
    if user_query := st.chat_input("Ask about my experience, certifications, or project impact..."):
        ...
        try:
            ...
            for h in st.session_state.chat_history:
                chat_context.append({"role": "user" if h["role"] == "user" else "model", "parts": [h["content"]]})
